...
var number = [2, -4, 5, -2, -11];

console.log(number[1], number[3], number[4]);
...
console.log(number[1], '- index:1,', number[4], '- index:4,', number[5], '- index:5,', number[6], '- index:6,', number[8], '- index:8,');
